...
class BuildPromoCard extends StatefulWidget {
  // const BuildPromoCard({ Key? key }) : super(key: key);
  final int itemIndex;
  final int proID;
  ...
  @override
  _BuildPromoCardState createState() => _BuildPromoCardState();
}

class _BuildPromoCardState extends State<BuildPromoCard> {
  @override
