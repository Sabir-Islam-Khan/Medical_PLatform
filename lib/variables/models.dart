...
class DetailedUserInfo {
  ...
  factory DetailedUserInfo.fromJson(dynamic jsonData) {
    return DetailedUserInfo(
      ...
      jsonData['languages'] as String,
      jsonData['currency_name'] as String,
      jsonData['has_completed_profile'] as bool,
      jsonData['has_delivery_address'] as bool,
    );
  }

  @override
  String toString() {
    return '{${this.links},${this.aboutMe},${this.address},${this.allergies},${this.building},${this.country},${this.countryCode},${this.designation},${this.givenName},${this.userID},${this.idReg},${this.idType},${this.lastName},${this.lastSeen},${this.nationality},${this.phoneNo},${this.preExisitngCon},${this.selfieFile},${this.unitNo},${this.username},${this.zipCode}, ${this.email}, ${this.languages}';
  }
}
...
class ProductMeta {
  int pageNo, perPage, totalItems, totalscreens;

  ProductMeta(this.pageNo, this.perPage, this.totalItems, this.totalscreens);

  factory ProductMeta.fromJson(dynamic jsonData) {
    return ProductMeta(jsonData['page'] as int, jsonData['per_page'] as int,
        jsonData['total_items'] as int, jsonData['total_screens'] as int);
  }

  @override
  String toString() {
    return '{${this.pageNo},${this.perPage},${this.totalItems},${this.totalscreens}}';
  }
}
...
class CartItemsArr {
  ...
  factory CartItemsArr.fromJson(dynamic jsonData) {
    return CartItemsArr(
      ...
      jsonData['supplier_id'] as int,
      jsonData['ttl_amount'] as int,
      jsonData['supplier_name'] as String,
    );
  }

  @override
  String toString() {
    return '{${this.links},${this.amount},${this.brand},${this.currency},${this.discount},${this.featurePic},${this.id},${this.model},${this.orderID},${this.orderReceivedID},${this.productID},${this.quantity},${this.receiptID},${this.supplierID},${this.totalAmt}, ${this.supplierName}}';
  }
}
...
class CompanyArr {
  ...
  factory CompanyArr.fromJson(dynamic jsonData) {
    return CompanyArr(
        ...
        jsonData['unit_num'] as String,
        jsonData['postal_code'] as String,
        jsonData['business_radius'] as int,
        jsonData["country"] as String);
  }

  @override
  String toString() {
    return '{${this.links},${this.address},${this.building},${this.timestamp},${this.companyID},${this.latitude},${this.logoFile},${this.longitude},${this.companyName},${this.unitNum},${this.zipCode}}';
  }
}
